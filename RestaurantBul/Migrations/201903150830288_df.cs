    ...
    public partial class df : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        CatPlaceId = c.Int(nullable: false, identity: true),
                        PlaceId = c.Int(nullable: false),
                        CategoryId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.CatPlaceId)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.CatPlaces", "PlaceId", "dbo.Places");
            DropForeignKey("dbo.CatPlaces", "CategoryId", "dbo.Categories");
            ...
            DropIndex("dbo.CatPlaces", new[] { "CategoryId" });
            DropIndex("dbo.CatPlaces", new[] { "PlaceId" });
